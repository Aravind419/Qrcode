...
END:VCARD`;
  ...
  setupEventListeners() {
    ...
    this.downloadBtn.addEventListener("click", () => this.handleMobileButtonClick('download'));
    this.shareBtn.addEventListener("click", () => this.handleMobileButtonClick('share'));
  ...
  handleMobileButtonClick(action) {
    if (this.isMobileDevice()) {
        const warningModal = document.createElement('div');
        warningModal.className = 'mobile-warning-modal';
        warningModal.innerHTML = `
            <div class="warning-content">
                <i class="fas fa-exclamation-circle"></i>
                <h3>Desktop Mode Recommended</h3>
                <p>For better ${action} functionality, please use desktop mode in your browser.</p>
                <div class="browser-tips">
                    <div class="tip">
                        <strong>Chrome:</strong> Menu (⋮) → Desktop site
                    </div>
                    <div class="tip">
                        <strong>Safari:</strong> "aA" → Request Desktop Website
                    </div>
                </div>
                <button class="continue-anyway">Continue Anyway</button>
        ...
        warningModal.querySelector('.continue-anyway').onclick = () => {
